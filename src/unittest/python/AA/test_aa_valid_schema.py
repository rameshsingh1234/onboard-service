...
@pytest.mark.parametrize(
    ...
    aa_test_data.aa_valid_schema)
def test_aa_valid_schema(url, client_id, client_secret, user_type, entity_type, request_body, expected_status):
    """
...
@pytest.mark.parametrize(
    "url, client_id, client_secret, user_type, entity_type, request_body, expected_status",
    aa_test_data.aa_request_schema)
